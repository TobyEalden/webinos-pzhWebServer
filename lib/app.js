...
PzhProviderWeb.startWebServer = function (host, address, port, config, cb) {
    ...
    function setRoutes(app, address, port, authConfig, tlsServerConfig) {
        ...
        // Toby
        // Add aegis ppg portal.
        require('./routes/appg/index.js')(app, authConfig, routeutil, serverAddress);
        // Add aegis ppg REST API
        require('./routes/appg/api/index.js')(app, authConfig, routeutil, serverAddress);
    }
